...
const OverviewCard = () => {
  ...
  const orderStatusData = [
    { status: "Completed", value: 65, count: 809, color: "#3841C0" },
  ...
  const topCategories = [
    { name: "Pharma", change: 5.0, percentage: 60, color: "#3841C0" },
  ...
  const COLORS = ["#3841C0", "#B1EEE2", "#F2960F", "#EB242699"]
    ...
    if (active && payload && payload.length) {
      return (
        <div className="rounded bg-white p-2 shadow-md">
          ...
          <p className="text-[#3841C0]">Sales: {payload[0].value.toLocaleString()}</p>
          ...
          <div className="flex w-full cursor-pointer gap-3 max-sm:flex-col">
            ...
            <div className="small-card rounded-md p-2 transition duration-500 md:border">
              <div className="flex items-center justify-between border-b pb-4 max-sm:mb-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    <div className="h-2 w-2 rounded-full bg-[#3841C0]"></div>
